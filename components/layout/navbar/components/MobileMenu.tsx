...
export default function MobileMenu({
  ...
  return (
    ...
    >
      ...
      {/* Search Bar & Theme Toggle (Aligned) */}
      ...
      {/* Primary Menu Items */}
      <Box sx={{ flexGrow: 1, overflowY: "auto", px: 2 }}> {/* Added left padding for alignment */}
        <List>
          {primaryMenu.map((item) => (
            <ListItem
              ...
              sx={{
                ...
                px: 0, // Remove default padding to match divider
              }}
            >
              <ListItemText
                primary={item.title}
        ...
        {/* Divider Between Primary and Secondary Menu (Aesthetic) */}
